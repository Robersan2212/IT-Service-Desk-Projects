  ...
  return (
    <StyledWrapper>
      <div className="select">
        <div className="selected" data-default="Length" data-one="12 characters" data-two="16 characters" data-three="18 characters">
        ...
        <div className="options">
          ...
          <div title="option-3">
            <input 
              ...
              onChange={handleLengthSelect}
            />
            <label className="option" htmlFor="option-3" data-txt="18 characters" />
          </div>
        </div>
      </div>
    </StyledWrapper>
